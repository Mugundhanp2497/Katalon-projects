...
IdeaName = WebUI.getText(findTestObject('full demo check/get challenge name'))

Challengename = ('Idea Name :' + IdeaName)
...
s.getRow(22).getCell(2).setCellValue(Challengename)

s.getRow(29).getCell(2).setCellValue(Challengename)

s.getRow(30).getCell(2).setCellValue(Challengename)

s.getRow(31).getCell(2).setCellValue(Challengename)

s.getRow(32).getCell(2).setCellValue(Challengename)

s.getRow(33).getCell(2).setCellValue(Challengename)

s.getRow(34).getCell(2).setCellValue(Challengename)
