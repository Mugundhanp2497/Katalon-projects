...
WebUI.setText(findTestObject('whiteboard/Invite email'), findTestData('Whiteboard').getValue('File location', 3))

WebUI.setText(findTestObject('whiteboard/invite firstname'), findTestData('Whiteboard').getValue('File location', 4))

WebUI.setText(findTestObject('whiteboard/invite lastname'), findTestData('Whiteboard').getValue('File location', 5))

WebUI.click(findTestObject('whiteboard/invite submit'))
